...
//  Quizzler-iOS13
//
//  Created by Usuário on 27/11/22.
...
struct QuizBrain {
    ...
    mutating func checkAnswewr(_ userAnswer : String) -> Bool {
    ...
    func updateBottons() -> String{
        var bottonText = quiz[questionNumber].optionButton[1]
        return bottonText
    }
}
